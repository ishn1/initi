      ...
      <div class="main-content main-content1">
        <div class="container">
          ...
          <div class="restaurant d-flex flex-wrap" itemscope itemtype="https://schema.org/Product">
            <div class="restaurant-lt col-md-9">
            ...
            <div class="restaurant-rt col-md-3">
              <a href="#" class="btn search"><input type="text" placeholder="Search..."></a>
            </div>
          </div>
          <!--resturant end-->
          <!--map start-->
          <div class="map" itemscope itemtype="https://schema.org/Map">
            <figure><img src="images/map_img.png" width="1154" height="543" alt="img"></figure>
          </div>
          <!--map end-->
			<div id="bottom"></div>
                ...
                <div class="proin">
                  <div class="login-in">
                    <div class="login-lt">
                      ...
                      <a href="#" class="read">Read More <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                    </div>
                  </div>
                </div>
              </div>
